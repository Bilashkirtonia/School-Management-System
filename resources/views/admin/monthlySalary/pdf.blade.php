...
<head>
    ...
    <title>student registation fee pdf</title>
</head>
<style>
    *{
        margin: 0;
...
<body>
    <div class="container">
        ...
        <div class="row_1">
            <div class="text">
                <h4 style="font-size: 20px; text-align:center; padding-bottom:10px; ">Stusent Registation slip (student copy)</h4>
            </div>
        </div>
        <table>
            @php
        ...
        <div class="row_1">
            <div class="text">
                <h4 style="font-size: 20px; text-align:center; padding-bottom:10px;">Stusent Registation slip (office copy)</h4>
            </div>
        </div>
        <table>
            @php
