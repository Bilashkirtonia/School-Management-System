                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>
                              ...
                              <a href="{{ route('setup.student.aasign.view') }}" class="btn btn-success btn-sm float-end">
                                <i class="fa fa-list"></i> Assing subject list
                            </a></h3>
                        </div>
                    </div>
                    <div class="card-body bordered shadow p-4">
                      <form action="{{ route('setup.student.aasign.store') }}" method="post" id="FormData">
                        @csrf
                        <div class="add-item">
                          <div class="row mb-5" >
