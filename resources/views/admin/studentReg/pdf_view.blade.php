    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Roll No.</td>
                    <td>{{ $AssingStudent->user->roll }}</td>
                </tr>
                <tr>
                    <td>Mobile Number</td>
                    <td>{{ $AssingStudent->user->mobile }}</td>
                </tr>
                <tr>
                    <td>Address</td>
                    <td>{{ $AssingStudent->user->address }}</td>
                </tr>
                <tr>
                    <td>Gender</td>
                    <td>{{ $AssingStudent->user->gender }}</td>
                </tr>
                <tr>
                    <td>Religion</td>
                    <td>{{ $AssingStudent->user->religion }}</td>
                </tr>
                <tr>
                    <td>Date of birth</td>
                    <td>{{ $AssingStudent->user->dob }}</td>
                </tr>
            </tbody>
        </table>
