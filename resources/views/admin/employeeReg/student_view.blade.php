                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>Employee Registation <a href="{{ route('setup.employee.registation.add') }}" class="btn btn-success btn-sm float-end">
                                <i class="fa fa-plus-circle"></i> Employee Registation   
                            </a></h3>
                        </div>
                    </div>
                    <div class="card-body">
                     {{-- <form action="{{ route('setup.employee.registation.store') }}" method="get" id="FormData">
                        <div class="row">
                            <div class="col-4">
                             <div class="mb-3">
                                ...
                                @foreach ($AssingStudent as $key => $class)
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <a href="{{ route('setup.employee.registation.edit',$class->id )}}"  class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                            <a target="_blank" href="{{ route('setup.employee.registation.pdf.view',$class->id  )}}"  class="btn btn-danger btn-sm"><i class="fa fa-check"></i></a> 
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
