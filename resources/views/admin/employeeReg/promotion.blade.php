            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body bordered shadow p-4">
                        <div class="row">
                            <div class="col">
                                <form action="{{ route('setup.student.registation.promotion.store',$AssingStudent->student_id) }}" method="post" id="FormData" enctype="multipart/form-data">
                                    @csrf                                   
                                    <div class="row">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">                                        
                                      ...
                                      <div class="col-2">
                                        <div class="mb-3">
                                          @if (@$AssingStudent)
                                          <input type="submit" class="btn btn-success" value="Promotion" > 
                                          @else
